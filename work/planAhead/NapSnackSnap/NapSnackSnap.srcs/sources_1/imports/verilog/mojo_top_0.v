...
module mojo_top_0 (
  ...
  wire [2-1:0] M_ctr_sevensegdisplay_value;
  counter_26 ctr_sevensegdisplay (
    .clk(clk),
    .rst(rst),
    .value(M_ctr_sevensegdisplay_value)
  );
  ...
  gameonemanager_27 gameonemanager (
    .clk(clk),
    .rst(rst),
  ...
  gametwomanager_28 gametwomanager (
    .clk(clk),
    .rst(rst),
  ...
  gamethreemanager_29 gamethreemanager (
    .clk(clk),
    .rst(rst),
  ...
  decimaltosevenseg_31 decimaltosevenseg (
  ...
  always @* begin
    ...
    case (M_gameselectstate_q)
      NAP_gameselectstate: begin
        ...
        io_led[0+7-:8] = M_gameonemanager_playerleds[0+1-:2];
        io_led[8+7-:8] = M_gameonemanager_playerleds[2+1-:2];
        io_led[16+7-:8] = M_gameonemanager_playerleds[4+1-:2];
      ...
      SNACK_gameselectstate: begin
        ...
        io_led[0+7-:8] = M_gametwomanager_playerthreescore;
        io_led[8+7-:8] = M_gametwomanager_playertwoscore;
        io_led[16+7-:8] = M_gametwomanager_playeronescore;
      ...
      SNAP_gameselectstate: begin
        ...
        io_led[0+7-:8] = M_gamethreemanager_playerthreescore;
        io_led[8+7-:8] = M_gamethreemanager_playertwoscore;
        io_led[16+7-:8] = M_gamethreemanager_playeronescore;
    ...
    case (M_ctr_sevensegdisplay_value)
      1'h0: begin
        io_seg = ~M_sevensegzero_segs;
        io_sel = 4'he;
      end
      1'h1: begin
        io_seg = ~M_sevensegone_segs;
        io_sel = 4'hd;
      end
      2'h2: begin
        io_seg = ~M_sevensegtwo_segs;
        io_sel = 4'hb;
      end
      default: begin
        io_seg = 8'hff;
