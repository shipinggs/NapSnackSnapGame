...
module gamethreemanager_28 (
  ...
  countdowntimer_52 countdowntimer2 (
    .clk(clk),
    .rst(rst),
  ...
  inputcountdowntimer_55 inputcountdowntimer2 (
    .clk(clk),
    .rst(rst),
  ...
  conditionalcounter_67 roundcounter2 (
    .clk(clk),
    .rst(rst),
  ...
  gamethreeplayer_68 gamethreeplayerone (
    .clk(clk),
    .rst(rst),
  ...
  gamethreeplayer_68 gamethreeplayertwo (
    .clk(clk),
    .rst(rst),
  ...
  gamethreeplayer_68 gamethreeplayerthree (
    .clk(clk),
    .rst(rst),
  ...
  conditionalcounter_71 randomaccessctr (
    .clk(clk),
    .rst(rst),
  ...
  conditionalcounter_71 randomaccessctr2 (
    .clk(clk),
    .rst(rst),
  ...
  gamethreeanswerrom_73 gamethreeanswerrom (
  ...
  gamethreenumberrom_74 gamethreenumberrom (
  ...
  gamethreecomparator_75 gamethreecompareone (
  ...
  gamethreecomparator_75 gamethreecomparetwo (
  ...
  gamethreecomparator_75 gamethreecomparethree (
